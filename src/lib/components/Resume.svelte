...
<div class="w-full max-w-5xl mx-auto">
	...
	<div class="pdf-viewer-card relative overflow-hidden rounded-2xl lg:rounded-3xl">
		...
		<div
			class="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-cyan-500/10 opacity-50"
		></div>
		...
		<div class="relative z-10 p-3 sm:p-4 lg:p-6">
			...
			<div class="flex items-center gap-3 mb-4">
				<div
					class="hidden sm:flex w-10 h-10 lg:w-12 lg:h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 items-center justify-center shadow-lg shadow-blue-500/25"
				>
					<svg
				...
				<div>
					<h3 class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: var(--text-heading);">
						Resume
					</h3>
			...
			{#if isIOS}
				...
				<div
					class="mt-3 flex flex-col sm:flex-row items-center justify-center gap-3 p-4 rounded-xl"
